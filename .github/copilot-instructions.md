...
### How to use Serena:
1. call check_onboarding_performed tool to ensure onboarding is done
2. call initial_instructions tool to get the latest instructions how to use Serena effectively
